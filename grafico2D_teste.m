...
for i=1:NP
 ...
 le=['Eav(' num2str(epoca) ') = ' num2str(sse)];
      ...
      xla=xlabel('Corrente (A)'); 
      yla=ylabel('Tempo (s)');  
      tit=title('Resposta do Modelo MLP - Circuito_RL');
      legenda=legend('Conjunto de treinamento','Modelo MLP, (Interpolação)','Modelo MLP, (Generalização)',le,'location', 'northwest');
